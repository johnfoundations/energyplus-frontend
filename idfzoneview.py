...
class idfZoneView(QtGui.QWidget):
    ...
    def createToolActions(self):
        ...
        self.snappoint.setIcon(QtGui.QIcon("icons/stock_snap-object-points.png"))
        ...
        self.snaporth.setIcon(QtGui.QIcon("icons/stock_snap-guides.png"))
        ...
        self.snapline.setIcon(QtGui.QIcon("icons/stock_snap-margins.png"))
        ...
        self.addsurface.setIcon(QtGui.QIcon("icons/button-fewer.png"))
        ...
        self.addwindow.setIcon(QtGui.QIcon("icons/button-fewer.png"))
        ...
        self.addzone.setIcon(QtGui.QIcon("icons/button-fewer.png"))
    ...
    def createNavigateActions(self):
        ...
        self.north.setIcon(QtGui.QIcon("icons/go-bottom.png"))
        ...
        self.south.setIcon(QtGui.QIcon("icons/go-top.png"))
        ...
        self.east.setIcon(QtGui.QIcon("icons/go-first.png"))
        ...
        self.west.setIcon(QtGui.QIcon("icons/go-last.png"))
        ...
        self.up.setIcon(QtGui.QIcon("icons/draw-cross.png"))
        ...
        self.drillin.setIcon(QtGui.QIcon("icons/view-sort-descending.png"))
        ...
        self.drillout = QtGui.QAction('View Next Layer Out', self)
        self.drillout.setShortcut('Alt+>')
        self.drillout.setIcon(QtGui.QIcon("icons/view-sort-ascending.png"))

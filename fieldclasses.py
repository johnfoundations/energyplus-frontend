...
class FieldReal(FieldAbstract) :
    ...
    def createEditor(self,parent,index)  :
        ...
        self.fieldeditor.setValidator(QtGui.QDoubleValidator(self.fieldeditor))
        self.fieldeditor.validator().setDecimals(8)
        if self.minv:
        ...
        if not self.default:
            self.fieldeditor.setText(str(self.default))
